...
button = customtkinter.CTkButton(app, text="Open Data", command=button_callback)
button.grid(row=0, column=0, padx=10, pady=10, sticky='ew', columnspan=2)

header_label = customtkinter.CTkLabel(app, text='Header Lines', anchor="w")
header_label.grid(row=1, column=0, padx=10, pady=10, sticky='ew')

header_entry = customtkinter.CTkEntry(app)
header_entry.grid(row=1, column=1, padx=10, pady=10, sticky='ew')

verbosity_checkbox = customtkinter.CTkCheckBox(app, text="Increase Verbosity")
verbosity_checkbox.grid(row=2, column=0, padx=10, pady=10, sticky='ew', columnspan=2)

dim_frame = customtkinter.CTkFrame(app)
